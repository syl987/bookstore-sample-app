...
import { UserBookDTO, UserBookEditDTO, UserBooksDTO } from 'src/app/models/book.models';
...
export const editUserBookDraft = createAction('[UserBooks] edit draft', props<{ id: string; data: UserBookEditDTO }>());
