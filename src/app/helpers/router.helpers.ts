...
export function collectActivatedRouteSnapshotData(snapshot: ActivatedRouteSnapshot | null | undefined, accessor: (snapshot: ActivatedRouteSnapshot) => Data | Params): ReturnType<typeof accessor> {
    if (!snapshot) {
        return {};
    }
    let result = {};
