...
export class AppDataServiceFactory implements Pick<DefaultDataServiceFactory, 'create'> {
    constructor(private readonly definitionService: EntityDefinitionService, private readonly dataService: DataService, private readonly config: DefaultDataServiceConfig) {}
...
export class AppDataService<T> implements EntityCollectionDataService<T> {
    ...
    constructor(protected readonly entityName: string, private readonly definitionService: EntityDefinitionService, private readonly dataService: DataService, config: DefaultDataServiceConfig) {
